<div className={'mdx-layout'}>
  <section>
    ...
    > See the [DK Address Data Features](dk-address) documentation for more details on the `address` entity and its features.
    ...
    | Concept     | Description                                                           |
    | ----------- | --------------------------------------------------------------------- |
    | **Feature** | A single attribute that consists values with timestamps (time series) |
